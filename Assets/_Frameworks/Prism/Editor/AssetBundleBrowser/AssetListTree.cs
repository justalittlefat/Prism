...
namespace Prism
{
    internal class AssetListTree : TreeView
    {
        ...
        protected override void DoubleClickedItem(int id)
        {
            ...
            if (assetItem != null)
            {
                UnityEngine.Object o = AssetDatabase.LoadAssetAtPath<UnityEngine.Object>(assetItem.asset.fullAssetName);
        ...
        protected bool IsValidDragDrop(DragAndDropArgs args)
        {
            ...
            if (Prism.AssetBundleModel.Model.DataSource.IsReadOnly ())
                return false;
