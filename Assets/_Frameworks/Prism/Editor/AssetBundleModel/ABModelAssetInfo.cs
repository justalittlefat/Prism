...
namespace Prism.AssetBundleModel
{
    public class AssetTreeItem : TreeViewItem
    {
        ...
        public AssetTreeItem(AssetInfo a) : base(a != null ? a.fullAssetName.GetHashCode() : UnityEngine.Random.Range(int.MinValue, int.MaxValue), 0, a != null ? a.displayName : "failed")
        {
            m_asset = a;
            if (a != null)
