...
namespace Prism
{
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu
    {
        ...
        [SerializeField]
        public AssetFolderTab m_AssetFolderTab;
        ...
        [MenuItem("Prism/AssetBundle Browser", priority = 2050)]
        ...
        private void OnGUI()
        {
            ...
            {
                case Mode.Folders:
                    m_AssetFolderTab.OnGUI(GetSubWindowArea());
                    break;
                case Mode.Builder:
        ...
        void ModeToggle()
        {
            ...
            string[] labels = new string[4] { "Folders","Configure", "Build", "Inspect" };
